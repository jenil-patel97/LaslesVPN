...
const Plans = () => {
  return (
    <div className="bg-[#F6F6F6] py-6">
      <p className="text-center font-bold text-2xl cursor-default">Choose Your Plan</p>
      ...
      <div className="container grid grid-cols-3 space-x-8 mx-auto">
        <div className="mt-6 border border-[#DDDDDD] bg-white">
          ...
          <h3 className="ml-[180px] font-bold mt-[30px] cursor-default">Free Plan</h3>
          <img src={group1} alt="grp1" className="mt-8 ml-[110px]" />
          <p className="font-bold mt-[120px] ml-[180px] text-xl cursor-default">Free</p>
        ...
        <div className="mt-6 border border-[#DDDDDD] bg-white">
          <img src={Free} alt="free" className="ml-[140px] mt-[90px]" />
          <h3 className="ml-[160px] font-bold mt-[30px] cursor-default">Standard Plan</h3>
          <img src={group2} alt="grp2" className="mt-8 ml-[110px]" />
          <p className="font-bold mt-[80px] ml-[180px] text-xl cursor-default">$9 / mo</p>
          <button className="mt-5 ml-[120px] mb-4 rounded-full py-2 px-16 border border-red-500 text-red-500 font-bold">
            Select
          </button>
        </div>
        <div className="mt-6 border border-[#F53838] bg-white">
          <img src={Free} alt="free" className="ml-[140px] mt-[90px]" />
          <h3 className="ml-[160px] font-bold mt-[30px] cursor-default">Premium Plan</h3>
          <img src={group3} alt="grp3" className="mt-8 ml-[110px]" />
          <p className="font-bold mt-[40px] ml-[180px] text-xl cursor-default">$12 / mo</p>
